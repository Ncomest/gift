...
//  const cardContainerCopy = cardContainer.cloneNode(true);
//  mainSection.appendChild(cardContainerCopy);

//  document.body.appendChild(mainSection);
// } else {
//  const verificationDiv = document.createElement("div");
//  verificationDiv.textContent = "Не пройдена верификация";
